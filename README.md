...
![AstryxOS desktop — Orbit shell, File Explorer, Text Editor, Settings, Calculator and Terminal running on the in-kernel compositor](docs/screenshots/desktop-v2.png)
