//! Classic VGA 8x16 bitmap font for ASCII characters 32–126.
//!
//! Each glyph is 8 pixels wide × 16 pixels tall, stored MSB-first
//! (bit 7 = leftmost pixel). 95 printable ASCII characters, 16 bytes each.
//! Data sourced from the traditional IBM VGA ROM font (public domain).

/// 8×16 VGA font data for printable ASCII (space 0x20 through tilde 0x7E).
